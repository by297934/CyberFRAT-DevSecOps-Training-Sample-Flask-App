    ...
    stage('Check for Secrets') {
      steps {
        script {
          ...
          sh "docker run trufflesecurity/trufflehog:latest git https://github.com/by297934/CyberFRAT-DevSecOps-Training-Sample-Flask-App --json > trufflehog-report.json || true"
